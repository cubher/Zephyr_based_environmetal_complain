...
- Stable multi-threaded operation under Zephyr RTOS
- Reliable UART communication with ESP8266
- Real-time data visible on web dashboard
- Successful SQL data persistence
...
- Practical Zephyr RTOS usage on STM32
- Device Tree–driven hardware abstraction
- Real-world UART + Wi-Fi module integration
- Embedded-to-web data pipelines
- Reliability design for small IoT nodes

---

## Limitations & Scope

- AT-command-based ESP8266 (no native TCP/IP stack on MCU)
- HTTP polling instead of MQTT
- No encryption (can be extended with TLS-capable modules)

---

## Possible Extensions

- MQTT-based cloud ingestion
- TLS-enabled Wi-Fi module
...
**Cubher**  
Embedded Systems | Zephyr RTOS | IoT Firmware

---

⭐ Star the repository if you’re interested in Zephyr-based embedded IoT systems